/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 21e35d8d71aabf97ca7616518a5198f7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		MY_WORKFLOW: Workflow<Parameters<import("./src/index").EmailWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_KEY" | "RESEND_FROM" | "RESEND_BCC" | "RECIPIENT_EMAIL">> {}
}
